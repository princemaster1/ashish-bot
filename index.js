/**
   * Create By ᬊ͜͡𐎸͍͐☠️☿𝐀̇ᷧ𝐒̇ᷤ𝐇̇ⷩ𝐈̇ͥ𝐒̇ᷤ𝐇̇ⷩ 𝐌̇ⷨ𝐀̇ᷧ𝐊̇ⷦ𝐄̇ⷷ𝐑̇ᷢ〽©️
   * Base by Dika Ardnt
*/
...
async function startjobotz() {
    const jobotz = makeWASocket({
        ...
        browser: ['ᬊ͜͡𐎸͍͐☠️☿𝐀̇ᷧ𝐒̇ᷤ𝐇̇ⷩ𝐈̇ͥ𝐒̇ᷤ𝐇̇ⷩ 𝐌̇ⷨ𝐀̇ᷧ𝐊̇ⷦ𝐄̇ⷷ𝐑̇ᷢ〽©️ V3', 'Safari','1.0.0'],
        auth: state
    })
